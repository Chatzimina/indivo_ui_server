...
#STATIC_HOME = JMVC_HOME + '/static'
STATIC_HOME = '/'+APP_HOME+'/static'
#STATIC_HOME = JMVC_HOME + SUBMODULE_NAME +'/static'
#APP_HOME = settings.SERVER_ROOT_DIR + '/apps/'+SUBMODULE_NAME
#STATIC_HOME = settings.SERVER_ROOT_DIR + '/apps/'+SUBMODULE_NAME+'/static'
