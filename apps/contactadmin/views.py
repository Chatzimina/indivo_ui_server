"""
Views for the Indivo e-Consent Contact app
Chatzimina Maria
ICS-FORTH
"""
...
SERVER_PARAMS = {"api_base":"http://www.iphr.care:8000",
                 "authorization_base":"https://www.iphr.care:443"}
...
def contactadmin(request):
    ...
    api = get_api()
    result,content=api.account_send_message(account_email=email, message_id=message_id, body={'sender2':senderemail,'subject':subject, 'body':'Researcher email: '+senderemail+' '+message, 'num_attachments':'1', 'body_type': 'markdown'})

    if '200' == result['status']:
           message = 'Your message has been successfully sent'
    else:
	   message = result
    return render_template('reply',{'message':message})
