 ...
 *
 */
$.Controller.extend('UI.Controllers.Contact',
/* @Static */
{
},
/* @Prototype */
{
	...
	//	 var activeRecord = this.account.attr("activeRecord");
		this.account.get_contact(function(notifications) {
			self.element.html($.View('//ui/views/contact/show.ejs',{'notifications': notifications},{'record':record}));
		});
	}
});
